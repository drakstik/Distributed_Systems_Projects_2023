...
/** Tests naming server <code>delete</code> method.
    ...
    replicated.
 */
public class TestFinal_Naming_Deletion extends NamingTest {
    /** Test notice. */
    public static final String notice =
        "checking naming server delete method";
    /** Prerequisites. */
    public static final Class[] prerequisites = new Class[] {TestFinal_Naming_Replication.class};
    ...
    protected void perform() throws TestFailed {
        ...
        for(int access_counter = 0; access_counter < ACCESS_COUNT; ++access_counter) {
            try {
                ...
                throw new TestFailed("unable to access " + delete_file + " for reading", t);
            }
        }
     ...
     */
    private void testDeletion(Path path, int expected_deletions) throws TestFailed {
        boolean result;
        ...
        if(deletions < expected_deletions) {
            throw new TestFailed(path + " was not successfully deleted from storage " +
                                 "servers: expected at least " + expected_deletions + 
                                 " deletions, but got " + deletions);
        }
    }
    ...
    private class DeletionStorageServer extends TestStorageServer {
        ...
        DeletionStorageServer() throws IOException {
            super(TestFinal_Naming_Deletion.this);
                ...
                if(pathRequest.path == null) {
                    ...
                    if(valid_path) {
                        if(item_present) {
                            ...
                            synchronized(TestFinal_Naming_Deletion.this) {
                                ++deletions;
                            }
